...
struct cpuinfo {
  unsigned long long cpu[7]; // CPU_XXXX
  unsigned int runque;
  unsigned int runocc;
  unsigned int ctxt;
  unsigned int iget;
...
typedef struct {                                /*        Size */
  ...
  u_char  pri;                                  /*           1 */
  char   nice;                                  /*           1 */
  u_char  stat;                                 /*           1 */ // One character from the string "RSDZTW" where R is running, S is sleeping in an interruptible wait, D  is  waiting  in
